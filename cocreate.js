export class CoCreateMindmap extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    const cocreateCss = new URL('./css/outer.css', import.meta.url);
    const cocreateCss2 = new URL('./css/workspace.css', import.meta.url);
    ...
    link2.href = cocreateCss2;

    this.shadowRoot.append(link, link2); 
